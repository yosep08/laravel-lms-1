...
<head>
    ...
    <title>Tugas Pemprograman Web.</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href=''>TUGAS WEB.</a></div>
            <div class="menu">
                <ul>
    ...
    <div class="wrapper">
        ...
        <section id="home">
            ...
            <div class="kolom">
                <p class="deskripsi">Belajar Tugas Pemprograman Web</p>
                <h2>Belajar Programing Itu Mudah</h2>
    ...
    <div id="copyright">
        <div class="wrapper">
            &copy; 2024. <b>Tugas Web.</b> Kelompok 2.
        </div>
    </div>
